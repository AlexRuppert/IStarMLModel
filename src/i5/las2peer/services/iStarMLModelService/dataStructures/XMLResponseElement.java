package i5.las2peer.services.iStarMLModelService.dataStructures;
...
public class XMLResponseElement 
{
	...
	private ArrayList<XMLResponseElementChild> _children= new ArrayList<XMLResponseElementChild>();
