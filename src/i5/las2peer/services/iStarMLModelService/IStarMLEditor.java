...
public class IStarMLEditor {
	...
	private HashSet<String> _idHash= new HashSet<String>();
	private HashSet<StringTuple> _edgeHash=new HashSet<StringTuple>();
	...
	{	
		...
		_factory =SchemaFactory.newInstance(XMLConstants.W3C_XML_SCHEMA_NS_URI);
		_schema = _factory.newSchema(new StreamSource(new StringReader(getFile("./xsd/check.xsd"))));
	...
	{
		if(type.equals("resource")||type.equals("task")
	...
	{
		if(type.equals("is_part_of")||type.equals("is_a")
	 ...
	 * Loads an existing XML
	 * @param xml as string
	 * @param whether to validate the xml
	 * @return returns an empty string or an error message, if the validation of the XML fails
	 * @throws Exception
	 */
	 ...
	 * @param attributes array of attribute value pairs
	 * @throws Exception
	 */
	...
	private void createDependency(String ielementID, String type, String aref) throws Exception
	{
		...
		{
			//throw new Exception("Dependency ID: "+ielementID+" aref: "+aref+" of type "+type+" already existng");
